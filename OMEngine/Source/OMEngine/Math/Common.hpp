...
namespace OM::Math
{
    ...
    __forceinline XMVECTOR SplatOne() { return XMVectorSplatOne(); }
    __forceinline XMVECTOR CreateXUnitVector() { return g_XMIdentityR0; }
    __forceinline XMVECTOR CreateYUnitVector() { return g_XMIdentityR1; }
    __forceinline XMVECTOR CreateZUnitVector() { return g_XMIdentityR2; }
    __forceinline XMVECTOR CreateWUnitVector() { return g_XMIdentityR3; }
    __forceinline XMVECTOR SetWToZero(FXMVECTOR vec) { return XMVectorAndInt(vec, g_XMMask3); }
    __forceinline XMVECTOR SetWToOne(FXMVECTOR vec) { return XMVectorSelect(g_XMIdentityR3, vec, g_XMMask3); }
